  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem, idx){
        return  <div key={idx}>
          <Card company = {elem.companyName} post={elem.post} brandLogo = {elem.brandLogo} tag1 = {elem.tag1} tag2 = {elem.tag2} salary ={elem.pay} location ={elem.location} datePosted={elem.datePosted}/>
          </div>
      })}
    </div>
  )
